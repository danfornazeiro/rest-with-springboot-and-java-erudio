...
public class OperationsService {
    ...
    public double sum(String number1, String number2) {
        if(!NumberUtils.isNumeric(number1) || !NumberUtils.isNumeric(number2)) throw new FileNotFoundException("Please set a numeric value");
    ...
    public double squareRoot(String number){
        if (!NumberUtils.isNumeric(number)) throw new FileNotFoundException("Please set a numeric value");
