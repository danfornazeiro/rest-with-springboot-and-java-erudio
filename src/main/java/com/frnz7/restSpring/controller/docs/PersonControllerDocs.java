...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export people", description = "Export a page of people in XLSX or CSV format", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
                            content = {
    ...
    @Operation(summary = "Massive people creation", description = "Massive people creation with upload XLSX or CSV", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
                            content = {
